...
Adon is an all-in-one python framework for Ad-hoc Information Retrieval. It is highlighted for the following properties:
...
Now, let's start the journey with :doc:`sources/guides/quick-start`.
