        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.post(
                    url=request_url, headers=request_header, json=self.request_json, proxy="http://127.0.0.1:8890"
                ) as response:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--requests_filepath", default="../../../Data/Adon/NQ/openai/requests.jsonl")
